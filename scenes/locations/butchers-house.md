...
| No alcohol | Nothing in the house. Stopped 1954. | Suspicion about 1954 |
| Sleep deprivation | Dark eyes, pacing groove in floorboards (visible through window) | Well's dreams |
| Butchering habits | Block used more than livestock explains. Takes too long. Works alone, doors shut. | Atmosphere |
| Dogs' behaviour | Flinching, limping, freezing | Practices cruelty |
| Mound out back | Dog-sized. Other dogs avoid it. Villagers don't answer questions about missing dogs. | Atmosphere |

## Actions

### Census visit
- **Cost:** 1 action
- **What happens:** Answers on doorstep. Won't let them inside. Name, occupation, duration — correct, useless. Asks questions back (where staying, how long). He's mapping them.
- **Cover story:** *"Came with the settlers."* Actually from neighbouring village, was here before settlers arrived.
- **Smell:** Smoke, iron, dog, damp earth.
- **Result:** No information. Doesn't mention Barnaś family. Doesn't react to the name.

### Observe from distance
- **Cost:** Free
- **What happens:** Leaves dawn/dusk, forest path, returns hours later. Sometimes at night — half-dressed, barefoot. Dogs don't follow. Returns with mud on hands, scraped knuckles.
- **Result:** → [butcher-visits-the-well](../../clues/clues.md#butcher-visits-the-well)
...
- **Cost:** 1 action
- **⚠️ LETHAL RISK:** If he returns, he kills them. Dogs going silent = only warning. Track his absence carefully.
- **Door:** Unlocked.
...
- **Result:** Knife → Soldier connection. Drawer → what he did to the girl. → [butcher-compelled-to-feed](../../clues/clues.md#butcher-compelled-to-feed)
