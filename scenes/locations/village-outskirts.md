...
- **Cost:** 1 action per trip (3 trips needed). Each extra player helping cuts 1 trip. Michał Pytlak cuts 1 more (knows the terrain). Having the maps from [Wojewoda's office](wojewodas-office.md) cuts 1 more. Minimum 1 trip.
