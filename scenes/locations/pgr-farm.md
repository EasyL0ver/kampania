...
**Location:** State Agricultural Farm (Państwowe Gospodarstwo Rolne) on the edge of %NEW_VILLAGE% — fields, barns, livestock pens, tool shed, communal kitchen
**Present:** Michał Pytlak (always, during day), Barbara Kopacz (working hours), Zofia Pytlak (kitchen), Józef Nowak and Piotr Wiśniewski (labourers, variable)
...
- **Watch the workers** — count the actual people working vs the ledger. Only 7 real workers, but the ledger lists 8. One name doesn't match anyone here. → Seeds [Foreman cover-up](../../clues/clues.md#foreman-coverup)
...
- **Notice Barbara** — she works hard, avoids the men, speaks to no one unless spoken to. Visibly poorer than the others. → Rapport opportunity with [Barbara Kopacz](../../characters/barbara.md)
- **Zofia's kitchen** — functional, honest. She cooks for the workers. Nothing unusual here — she's just good at her job.
...
- **Cost:** 1 action
- **Outcome:** The desk in the tool shed has supply orders, delivery receipts, and expense reports. Numbers are mostly honest — this is a real working farm. But one entry stands out: Tadeusz Mazur, listed as a current worker drawing wages. No corresponding work logs for the past two years.
- **Leads to:** [Foreman cover-up](../../clues/clues.md#foreman-coverup). If confronted, Michał Pytlak enters Stage 1 deflection (see [foreman-embezzlement.md](../../story-facts/foreman-embezzlement.md)).
...
- **Cost:** Free
- **Outcome:** Ask about specific names. Real workers — he answers immediately. Tadeusz Mazur — he hesitates. "Mazur? He's... not been around lately. Seasonal work." He's a bad liar under direct questioning. His discomfort is guilt, not greed.
