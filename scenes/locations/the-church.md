...
**Location:** %NEW_VILLAGE% — the church on the hill, with cemetery adjacent
**Present:** ks. Władysław Pająk (inside, usually), Wanda Mazur (outside, by the cemetery, most days)
**Available:** Any day

## Setup

A wooden church on the hill above the village — suspiciously well-maintained for a place this poor. Fresh paint, solid roof, stacked firewood. Someone is funding this. Inside: dark, incense, icons, candles. A small parish — but cared for.

Adjacent: the cemetery. A few dozen graves, most weathered. One is freshly tended — flowers, a clean headstone. An older woman in black kneels beside it. Wanda Mazur. Nearby, a double grave with fresh flowers and a Polonised surname — well cared for, someone visits often.
...
### Talk to Priest
- **Requires:** Nothing
- **Cost:** Free (first visit), 1 action (deeper conversation)
- **Outcome:** ks. Władysław Pająk is cold by default. Polite, one-word answers. Government people. If players show faith, knowledge of commandments, or genuine spiritual respect — he warms up. See [Priest character file](../../characters/priest.md) for full interaction tree.
- **Leads to:** Priest thread (cold → warm → hints → breaks → ritual permission)
