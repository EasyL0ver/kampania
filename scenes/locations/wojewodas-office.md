...
**Location:** Zbigniew Gajda's house — the office room
**Present:** Zbigniew Gajda (usually), Irena Gajda (in the house)
**Available:** After arrival event

## Setup

The nerve centre of the village. Clean desk, heavy bakelite phone, ledgers, topographic maps spread across the surface. A shelf behind the chair — family photos, a crucifix, and a small dark wooden icon that doesn't quite match the rest. Tea always on the table. Zbigniew Gajda works here and receives visitors here.

Players can return to this location throughout the game.
