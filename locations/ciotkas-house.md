...
- **Requires:** Janina absent or distracted
- **Cost:** 1 action
- **Outcome:** The attic contains a box marked "EDEK" with adult male belongings, a teenage girl's dress, a child's rattle, a Singer sewing machine, and a small brass Greek Catholic liturgical bell with Cyrillic lettering; the sewing machine can be cross-checked with [PGR expense journal](../items/pgr-expenses.md), and the bell can be compared with the [cerkiew](old-village-cerkiew.md) or shown to [Stefania Kopacz](../characters/babcia.md) or [Paraskewia Chyłak](../characters/hag.md).
- **Gives:** [ciotka-lives-in-soldiers-house](../clues/clues.md#ciotka-lives-in-soldiers-house); Item / Evidence: adult effects marked "EDEK", girl's dress, child's rattle, Singer sewing machine, Greek Catholic bell.

### Dig in the backyard
- **Requires:** Reason to suspect the uneven backyard patch
- **Cost:** 1 action
