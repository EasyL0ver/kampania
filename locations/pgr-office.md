...
The nerve centre of the village. Clean desk, heavy bakelite phone, ledgers, topographic maps spread across the surface. A shelf behind the chair. Tea always on the table. Zbigniew Gajda works here and receives visitors here. The only phone in the village.
...
- **Cost:** 1 action
- **Skills:** **Bureaucracy**
- **Outcome:** Resettlement and registration paperwork ran through state offices, and a resettler leaves a paper trail even when a village agrees to forget her. Cross-referencing the transfer against the resettlement register turns up a forwarding entry: Marta Konieczna, relocated west to **Legnica**, registered employment as a **nurse**. A working address in a city hospital — and a telephone line the exchange can reach. → **Gives:** [marta-in-legnica](../clues/clues.md#marta-in-legnica)
- **Leads to:** [Marta Konieczna](../characters/secondary-characters.md#marta-konieczna) — call her ward line in Legnica.
...
- **Cost:** 1 action
- **Skills:** **Discretion**
- **Outcome:** Locked drawer in the desk. Players need to force it or find the key. A loaded sołtys's pistol. Having it changes the power dynamic — against Stanisław Rezeń, during a mob, or in the final car scene.
- **Leads to:** Players are armed. Zbigniew Gajda will notice it's missing eventually.
