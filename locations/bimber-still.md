...
- **The last survey crew** `(requires: [drinking buddy](../characters/wujas.md#drinking-buddy) with Tadek)` `(prompted by: [mission-is-a-front](../clues/clues.md#mission-is-a-front))` — The crew laugh about the state surveyors who came before: they drank more than they measured, drove a few stakes, and left early. → Gives: [geologists-were-drinking](../clues/clues.md#geologists-were-drinking)
