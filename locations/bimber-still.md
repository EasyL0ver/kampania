...
**Location:** Forest clearing between %NEW_VILLAGE% and %OLD_VILLAGE%, near a stream
**Present:** [Tadek Gajda](../characters/wujas.md), Szymek Kępa, Romek Głowacz, Franek Mucha (irregular evenings)
...
- **The last survey crew** `(requires: [drinking buddy](../characters/wujas.md#drinking-buddy) with Tadek)` `(prompted by: [committee-hides-the-flood](../clues/clues.md#committee-hides-the-flood))` — The crew laugh about the state surveyors who came before: they drank more than they measured, drove a few stakes, and left early. → Gives: [geologists-were-drinking](../clues/clues.md#geologists-were-drinking)
