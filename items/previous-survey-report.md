# The Previous Crew's Survey Report

**Type:** Item — official document (negligent survey)
**Source:** The committee's briefing dossier — carried from the start; [prof. Bieńkowski](../characters/professor.md) flagged it as thin at the briefing
**Carried:** Reference. The signed report whose flood projection sent the committee here.

## Description

An official, signed survey report in the briefing dossier, stamped and filed by the crew sent to re-check the terrain before resettlement. It reads clean to a layman. prof. Bieńkowski warned at the briefing that it smells thin, too few stations and too much taken on faith, though he could not prove it from Kraków. It praises the wojewoda's irrigation ditch, notes in passing that the river changed course and dismisses it, and says nothing at all about the ridge gap or the far-ridge streambed.
...
- **Requires:** Holding the report and having inspected the ditch ([ditch-drains-nothing](../clues/clues.md#ditch-drains-nothing))
- **Cost:** 1 action
