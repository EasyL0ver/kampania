...
**Reading it — Language (Cyrillic / Ukrainian) or Culture (Lemko):** The letters resolve into names. Twelve, then a space, then a thirteenth set slightly apart — **Dmytro Kosach**, held separate from the rest. In Latin letters:

> Wasyl Koval · Anna Koval · Semen Koval · Kateryna Koval · Petro Hnat · Pelagia Hnat · Mychajło Szafran · Fedir Mac · Olena Krywda · Hryhorij Pyś · Stepan Kiczura · Anastasija Sowa — and, apart, Dmytro Kosach.

Who they were is recorded in [the massacre file](../story-facts/old-village-massacre.md#the-dead-in-the-well). Only [Paraskewia](../characters/hag.md) knew them in life — she is the last person who can put a face to each name.

## Actions

### Read the names
- **Requires:** Holding the list; **Language** (Cyrillic/Ukrainian) or **Culture** (Lemko)
- **Cost:** Free
- **Outcome:** The players can now name the 1947 dead — the twelve villagers and Dmytro Kosach — the core of the [truth the rite requires](../events/the-ritual.md#the-dead-to-name). Without the skill, the names stay locked in the script until someone reads it for them.
