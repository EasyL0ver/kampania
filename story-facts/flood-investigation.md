...
| Search for the Benchmarks (event) | search for old markers; no skill; at [Far-Ridge Streambed] | `streambed-parameters` (open-ended, unknown time) |
