...
- `gap-fill-examined` — you climbed the plug and handled the fill: packed clay and shattered rock, not loose rubble. The observation, not yet the conclusion. The access cost for `gap-is-blocked`. Earned at [The Ridge Gap](../locations/the-ridge-gap.md), reached from the survey routes.
