...
- **The ridge water-gap** (`gap-is-blocked`) — the przełom, the valley's mapped outlet into the empty %BIG-BASIN%. False: a landslide has plugged it, and the plug's crest stands above the flood line, so the water can neither top it nor seep through into %BIG-BASIN%.
