...
- **Outcome:**
  ...
  - **The operator — the shock, and the wild guess** *(see [%OPERATOR%](../characters/secondary-characters.md#operator-the-telephone-exchange-operator))* — every attempt to reach the outside passes through the same flat woman's voice at the town exchange that has patched every call all game. She has spent the whole game holding down the urge to let this valley drown; the flood is the day she loses. Stage it so the refusal reads not as a broken line but as **a person choosing** — that contrast is the shock:
    - She answers. She's *there*, clear, present — clearer than the line has been all game. The players tell her the village is cut off, people will die, they need rescue. And she just… doesn't. *"There's nothing I can do from here."* Calm. Unhurried. Obscenely composed against their panic. They ask again, louder. The same flat courtesy: *"The line won't hold. Goodbye."* A dead phone can't stay *calm at you.* This one does. That's what tells the players — in the gut, not on paper — that someone on the other end is *deciding* to let them drown.
    - **The wild guess.** Reeling, a player may make the leap — no evidence, pure intuition, the vanished girl and this cold voice colliding: *"...Hania?"* If they say her name (or the one nerve only she would flinch at), run **the gasp** (see her GM note): a caught breath escapes her, then the cage slams shut — flat again, *"...Number, please,"* and the line dies for good. Unrepeatable, deniable, never confirmed. They walk away certain and empty-handed. **That is the experience:** shock at the non-compliance, a wild stab at the name, and an answer that is not an answer.
    - **Dependency:** this beat only detonates for a table that already knows [Hania Barnaś](../characters/jagna.md) was real and *vanished* (from the lynch investigation — `barnas-had-a-daughter`, `jagna-fled-the-lynch`). For players who never dug into '54, there is no name to guess and it plays as cold bureaucratic indifference — still eerie, but the payoff belongs to those who earned it.
    - Do **not** confirm it; do **not** let it be the thing that dooms them — the phone was never rescue (the powiat's *"we'll send someone when conditions allow"* above is the proof — bureaucracy doesn't rescue). To the GM it is Hania, letting the valley drown the way the valley once let her.
