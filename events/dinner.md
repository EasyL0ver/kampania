...
- [Helena Rzepka](../characters/matrona.md) asks aloud why [Janina Gajda](../characters/ciotka.md) is not at the table.
...
- Out into %NEW_VILLAGE%.
- To [the store](../locations/the-store.md) if Tadek invited them to drink.
