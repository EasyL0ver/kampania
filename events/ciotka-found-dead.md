...
Night of Day 2. After the wolf hunt. No one killed Janina Gajda — and, though the players can never prove it, **she didn't take her own life either.** For thirteen years she has leaned on Luminal to get through the nights — small nerve pills, a standing prescription filled quietly in town. That night, wrung out by the committee's presence and the walls closing in, exhausted and muddled and maybe steadied with a nip of bimber, she took too many. The narrow line between a dose that lets you sleep and one you don't wake from, crossed by a tired, frightened woman who wasn't counting. **GM certainty: it was an accident.** Not murder, not suicide — but the scene can't say so, and the village won't believe it.
...
**Edek is a red herring, and so is everyone else.** The village is primed to see murder — a family with this much buried guilt cannot believe one of their own just *died*. The players will be handed suspects (Edek, Rezeń, the hag) and, if they find the pills, the whisper of suicide. None of it is true. The horror is that an accidental death, plus a boy who ran, plus a valley that needs a culprit, manufactures a crime out of nothing.

## Setup

The players come to [Ciotka's house](../locations/ciotkas-house.md) for whatever reason — census follow-up, checking on her after the flood, delivering something, asking about Edek. Normal errands. Routine.

The door is unlocked. That's wrong — Janina always locks the door. Always.
...
Janina Gajda is on the kitchen floor. On her back, half-turned, as if she sat down hard and never got up. Eyes open. No wound, no blood, no marks on her — her hands are at her sides, one still half-curled around a fallen rosary. She looks less attacked than simply asleep. On the table above her: a glass with a finger of water left in it, and a small brown pill bottle on its side, cap off.
...
- **The body** — no wound, no blood, no marks anywhere on her. **Medicine:** No trauma, no strangulation, no defensive injuries — nothing was done *to* her. The stillness and the colour read like a deep-sleep death: breathing that slowed to nothing. Consistent with a sedative overdose, not violence.
...
- **The pill bottle** — small, brown prescription glass, cap off, on its side; a couple of tablets loose on the table, the rest gone. The label is a town apteka's — Luminal. **Medicine:** a barbiturate, for nerves and sleep; the bottle should hold far more than it does, and what's missing is enough to stop a heart. She washed them down with the glass of water and lay down. **Whether she miscounted or meant it, the bottle can't say.** → **Gives:** [ciotka-overdose](../clues/clues.md#ciotka-overdose)
- **The rosary** — fallen near her right hand. She was holding it, or reaching for it, at the end.
...
- **Outcome:**
  - **Medicine:** No trauma. No strangulation, no blunt force, no defensive wounds — she didn't grab at anything, didn't fight, because there was nothing to fight. This is a sedative death: the deep, slowed breathing of a barbiturate overdose, not a heart that simply failed and not a hand at her throat. The bottle on the table tells the rest. You cannot call this a killing.
  - **Milicjant:** Not a crime scene. No weapon, no robbery, no forced entry, no struggle — and an empty pill bottle by the body. The only genuinely strange thing is the empty corner where the boy slept. What's suspicious isn't the death. It's the flight.
  - **Observation:** Her apron is still tied. She was in the kitchen, up and working, when she took the pills and lay down. She went quietly.
- **Gives:** → [ciotka-overdose](../clues/clues.md#ciotka-overdose)

### Search the house
- **Cost:** 1 action
- **Outcome:** Everything the [location file](../locations/ciotkas-house.md) describes is still here — attic, backyard, icons, Edek's corner. The murder doesn't change the house's investigative value. But the emotional weight is different now. Searching a dead woman's house while she's on the floor.
- **Gives:** Same clues as [Ciotka's house](../locations/ciotkas-house.md) actions — but now the context is a murder investigation, not a census visit.

### Look for Edek
- **Requires:** Go outside, look around
- **Cost:** 1 action
- **Outcome:**
  - **Endurance / Observation:** Tracks in the mud (the flood helps — soft ground holds prints). Large bare footprints heading toward the tree line. Running — long stride, deep toe impressions. Someone went into the forest barefoot and fast. The tracks fade where the canopy starts and leaf litter covers the ground.
  - **Following deeper** requires another action and a reason to know where to look. The [UPA bunker](../locations/upa-bunker.md) is nearly invisible — players would need prior knowledge of it or extraordinary tracking to find him this way.
- **Gives:** Someone fled toward the forest, barefoot. Doesn't tell you if that person was a killer running or a witness fleeing.
...
**The truth (accidental overdose of her own sedatives; nobody killed her; Edek found her and ran) should emerge slowly** — through the pill bottle and the body itself (Medicine and Milicjant reads point to no crime), through finding Edek, and through the absence of any real evidence of violence. If players find the pills, a new false lead opens — *suicide* — but that too is wrong, and the scene can never confirm it either way; the GM knows it was an accident. The payoff isn't unmasking a killer. It's realizing there was never a killing — only a death, and a valley so soaked in guilt it manufactured a murderer.
