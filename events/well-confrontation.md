...
- From the ruins: Lemko chanting carries across the well clearing.
- From the forest path: the players hear dogs and a man's footsteps ahead.

## Setup

- [Paraskewia Chyłak](../characters/hag.md) kneels at the well rim.
...
- She chants in Lemko.
- [Stanisław Rezeń](../characters/butcher.md) arrives from the village path with three dogs.
...
- **Cost:** 1 composure; Wounded
- **Outcome:** The player carries [Paraskewia Chyłak](../characters/hag.md) clear; Rezeń does not pursue.
- **Gives:** World State Change: the hag survives but is badly hurt

### Fight him
- **Requires:** Present, no firearm, Violence, and at least one other player has completed [Grapple him](#grapple-him)
- **Cost:** 2 composure; fighter Wounded
- **Outcome:** The fighter drives Rezeń off while the dogs are occupied.
- **Gives:** World State Change: the hag survives and Rezeń knows the players' faces

### Draw a firearm
- **Requires:** Present and holding a gun — [Dudka's rifle](../characters/neighbour.md) or [Zbigniew's pistol](../characters/wojewoda.md)
- **Cost:** 1 composure if the player commits to shoot
...
### Shoot the retreating Rezeń
- **Requires:** [Draw a firearm](#draw-a-firearm) resolved and Rezeń is retreating
- **Cost:** 2 composure
